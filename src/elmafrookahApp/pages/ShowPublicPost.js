      ...
      <div className="postBody">
        ...
        {!post.videolink && !post.imge ? (
          ...
          >
            {post.vidorimg === "صورة" ? (
              post.typeofpost === "بروفايل" ? (
                <div className="postImage-box-profile">
        ...
        <div className="m-title-rate">
          <h3 style={{ color: "rgb(61, 127, 179)" }}>{post.title}</h3>
        </div>
        ...
        {post.writername ? (
          <div className="writer-box">
            <div className="img-box">
              <img
                className="writerimg"
                src={post.writerimge ? post.writerimge : blankImg}
                alt="item"
              />
            </div>
            <div>
              <p style={{ fontSize: "17px", padding: "0" }}>
                <span>الكاتب :</span>
                {post.writername}
              </p>
              {post.typeofpost === "بروفايل" ? (
